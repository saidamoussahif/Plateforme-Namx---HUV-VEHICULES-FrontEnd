...
//   useEffect(()=> { 
//     fetch('http://localhost:8000/api/Type'+_id, 
//   {
//       method:"GET", 
//       headers: {
...
//       <input type="email"  {...register("Email")}  name="Email" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
//     </div>
//     <div class="relative z-0 mb-6 w-full group">
//         <input type="text" {...register("Typ")} name="Type" id="floating_company" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="" required hidden />
...
function Reservation(){
    ...
    useEffect(()=> {
       const mydata= async (_id)=>{
       const res = await  fetch('http://localhost:8000/api/Type'+_id, 
       {
           method:"GET", 
           headers: {
               'Access-Control-Allow-Origin':'*',
